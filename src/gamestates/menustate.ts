...
export default class MenuState implements IGameMode {
    ...
    paramdlg = new ParamDialog(this.eventCtrl, this.modelStore)
    ...
    constructor(
        ...
        this.mdom.addMenu(new MenuIcon({ icon: Icons.BlueBook, color: IconsColor.Yellow, boxEnable: true, click: () => { this.paramdlg.show() } }))
